...
struct EngineInstallation {
    ...
    func prepare(connectName: String, showsInSpotify: Bool) throws -> Bool {
        ...
        // Builds up to 0.1.1 had owntone write its own logfile here, a copy
        // of what Logs/owntone.log already held. Nothing writes it now, and
    ...
    private func owntoneConfig() -> String {
        ...
        //
        // logfile is empty, which our patch makes mean none. In the
        // foreground owntone logs to the console anyway, and the helper
        // captures that into Logs/owntone.log and rotates it (EngineLog);
        // a logfile of owntone's own was the same log twice.
        """
